...
- (void)viewDidLoad {
  ...
  if (![GPPSignIn sharedInstance].authentication ||
    ...
    self.shareLabel.font = [UIFont Museo700Regular16];
    self.shareStatus.font = [UIFont Museo700Regular16];
    self.nativeShareboxLabel.font = [UIFont Museo500Regular10];
...
//    textView.font = [UIFont fontWithName:@"Helvetica" size:18];
      textView.font = [UIFont Museo700Regular16];
...
- (UITableViewCell *)editableCellForTableView:(UITableView *)tableView
  ...
  editableCell.textField.text = [_shareConfiguration textForCellAtIndexPath:indexPath];
    editableCell.textField.font = [UIFont Museo700Regular14];
